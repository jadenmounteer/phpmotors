...
/**
 * Inserts a new classification to the carclassifications table.
 */
...
/**
* Inserts a new vehicle to the inventory table.
*/
function newVehicle($classificationId, $invMake, $invModel,
...
*/
function updateVehicle($classificationId, $invMake, $invModel,
...
/**
* Deletes a vehicle in from the database
*/
function deleteVehicle($invId) {
    ...
    // Create the prepared statement using the phpmotors connection
    $stmt = $db->prepare($sql);
    // The replace the placeholder in the SQL
